    ...
    <div className="min-h-screen bg-gray-800 flex flex-col items-center px-4">
     <div className="w-full flex justify-start mt-4">
      ...
      <div className="bg-white shadow-lg rounded-xl p-8 max-w-md w-full text-center mt-4">
        <h1 className="text-2xl font-bold mb-2 text-gray-800">Sign Up to Monexis 🚀</h1>
        <p className="text-gray-500 mb-6">Create your account to manage finances</p>

        <form onSubmit={handleEmailSignup} className="space-y-4 mb-4 text-left">
          <input
            name="email"
            type="email"
            placeholder="Email"
